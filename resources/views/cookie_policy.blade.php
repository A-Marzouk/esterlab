...
@section('content')
    ...
    <div class="container mt-5">
        <h2>Cookies Policy of <span class="website_url">esterlab.org</span></h2>

        <p>This website, <span class="website_url">esterlab.org</span> (the "Website"), is operated by <span class="website_name">Esterlab</span>.</p>

        <h3>What are cookies?</h3>

        <p>Cookies are a small text files that are stored in your web browser that allows <span class="website_name">Esterlab</span> or a third party to recognize you. Cookies can be used to collect, store and share bits of information about your activities across websites, including on <span class="website_name">Esterlab</span> website.
        ...
        <p><span class="website_name">Esterlab</span> uses both session cookies and persistent cookies.</p>
        ...
        <h3>How do third parties use cookies on the <span class="website_name">Esterlab</span> Website?</h3>

        <p>Third party companies like analytics companies and ad networks generally use cookies to collect user information on an anonymous basis. They may use that information to build a profile of your activities on the <span class="website_name">Esterlab</span> Website and other websites that you've visited.</p>
