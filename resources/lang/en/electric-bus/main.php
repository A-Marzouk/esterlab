...
return [
    ...
    'main_description' => 'For too long, buses as a mean of transport have lived on their gains. Nowadays, technological innovations such as electrically-powered transport modes present a world of opportunities for revamping the bus experience on its own terms, matching mobility industry trends and the wider social evolution.',

    'description_1' => 'This design charter for “Tarpan” buses have been created to promote buses as a mode of transportation in their own right. ',
    'description_2' => '“Tarpan” forms the ecosystem of the ‘bus of tomorrow’. Design principles are illustrated by conceptual sketches, which should not be viewed as final design specifications. The manufacturer will be able to interpret and adapt these principles according to their own design culture and processes.',

    'main_target' => 'MAIN TARGET OF THE PROJECT',
    'target_1' => 'Production of electric/CNG/hybrid microbuses ',
    'target_2' => 'Reducing the bus weight',
    ...
    'benefits'=> 'BENEFITS',
    'benefit_1'=> 'Increased passenger capacity compared with the similar bus length, due to the better layout.',
    'benefit_2'=> 'Effective life cycle costs (fuel savings, fewer parts and reduced body repair costs, body life increased to 10 years compared to the similar microbuses).',
    ...
    'benefit_5'=> 'Corrosion resistance and adaptation to climatic conditions (hot and wet weather).',
    ...
    'interior_3'=> 'Wide aisles and wide doors allow rapid passenger flow ',
    'interior_4'=> 'Spacious interior results high comfort for passengers ',
    'interior_5'=> 'Compared to traditional equal length vehicles, more passengers can fit in ',
    'interior_6'=> 'Semi-automatic ramp for wheelchairs',
    'interior_7'=> 'Kneeling function',
