                        ...
                        <div class="data d-flex flex-column">
                            <div>
                                <a href="https://www.google.com/maps/place/ул.+Сечевых+Стрельцов,+60,+Киев,+04050/@50.4565667,30.4894762,17z/data=!4m5!3m4!1s0x40d4ce63673bc087:0xb0a3a2c1274c970!8m2!3d50.4569751!4d30.4899461/"
                                   target="_blank">{{getTrans('address')}}</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="w-100  d-flex justify-content-center align-items-center">
                        <div class="d-flex w-100">
                            <select name="countryCode" v-model="contactUsData.countryCode" class="selectionOptions">
                                <option data-countryCode="DZ" style="color:black;" value="213" :selected="true">Algeria
                                    (+213)
                                </option>
                                ...
                                <option data-countryCode="AI" style="color:black;" value="1264">Anguilla (+1264)
                                </option>
                                <option data-countryCode="AG" style="color:black;" value="1268">Antigua &amp; Barbuda
                                    (+1268)
                                </option>
                                ...
                                <option data-countryCode="AZ" style="color:black;" value="994">Azerbaijan (+994)
                                </option>
                                ...
                                <option data-countryCode="BD" style="color:black;" value="880">Bangladesh (+880)
                                </option>
                                <option data-countryCode="BB" style="color:black;" value="1246">Barbados (+1246)
                                </option>
                                ...
                                <option data-countryCode="BA" style="color:black;" value="387">Bosnia Herzegovina
                                    (+387)
                                </option>
                                ...
                                <option data-countryCode="BF" style="color:black;" value="226">Burkina Faso (+226)
                                </option>
                                ...
                                <option data-countryCode="CV" style="color:black;" value="238">Cape Verde Islands
                                    (+238)
                                </option>
                                <option data-countryCode="KY" style="color:black;" value="1345">Cayman Islands (+1345)
                                </option>
                                <option data-countryCode="CF" style="color:black;" value="236">Central African Republic
                                    (+236)
                                </option>
                                ...
                                <option data-countryCode="CK" style="color:black;" value="682">Cook Islands (+682)
                                </option>
                                <option data-countryCode="CR" style="color:black;" value="506">Costa Rica (+506)
                                </option>
                                ...
                                <option data-countryCode="CY" style="color:black;" value="90392">Cyprus North (+90392)
                                </option>
                                <option data-countryCode="CY" style="color:black;" value="357">Cyprus South (+357)
                                </option>
                                <option data-countryCode="CZ" style="color:black;" value="42">Czech Republic (+42)
                                </option>
                                ...
                                <option data-countryCode="DM" style="color:black;" value="1809">Dominica (+1809)
                                </option>
                                <option data-countryCode="DO" style="color:black;" value="1809">Dominican Republic
                                    (+1809)
                                </option>
                                ...
                                <option data-countryCode="SV" style="color:black;" value="503">El Salvador (+503)
                                </option>
                                <option data-countryCode="GQ" style="color:black;" value="240">Equatorial Guinea
                                    (+240)
                                </option>
                                ...
                                <option data-countryCode="FK" style="color:black;" value="500">Falkland Islands (+500)
                                </option>
                                <option data-countryCode="FO" style="color:black;" value="298">Faroe Islands (+298)
                                </option>
                                ...
                                <option data-countryCode="GF" style="color:black;" value="594">French Guiana (+594)
                                </option>
                                <option data-countryCode="PF" style="color:black;" value="689">French Polynesia (+689)
                                </option>
                                ...
                                <option data-countryCode="GP" style="color:black;" value="590">Guadeloupe (+590)
                                </option>
                                ...
                                <option data-countryCode="GW" style="color:black;" value="245">Guinea - Bissau (+245)
                                </option>
                                ...
                                <option data-countryCode="KP" style="color:black;" value="850">Korea North (+850)
                                </option>
                                ...
                                <option data-countryCode="KG" style="color:black;" value="996">Kyrgyzstan (+996)
                                </option>
                                ...
                                <option data-countryCode="LI" style="color:black;" value="417">Liechtenstein (+417)
                                </option>
                                <option data-countryCode="LT" style="color:black;" value="370">Lithuania (+370)</option>
                                <option data-countryCode="LU" style="color:black;" value="352">Luxembourg (+352)
                                </option>
                                ...
                                <option data-countryCode="MG" style="color:black;" value="261">Madagascar (+261)
                                </option>
                                ...
                                <option data-countryCode="MH" style="color:black;" value="692">Marshall Islands (+692)
                                </option>
                                <option data-countryCode="MQ" style="color:black;" value="596">Martinique (+596)
                                </option>
                                <option data-countryCode="MR" style="color:black;" value="222">Mauritania (+222)
                                </option>
                                ...
                                <option data-countryCode="FM" style="color:black;" value="691">Micronesia (+691)
                                </option>
                                ...
                                <option data-countryCode="MS" style="color:black;" value="1664">Montserrat (+1664)
                                </option>
                                <option data-countryCode="MA" style="color:black;" value="212">Morocco (+212)</option>
                                <option data-countryCode="MZ" style="color:black;" value="258">Mozambique (+258)
                                </option>
                                ...
                                <option data-countryCode="NC" style="color:black;" value="687">New Caledonia (+687)
                                </option>
                                ...
                                <option data-countryCode="NF" style="color:black;" value="672">Norfolk Islands (+672)
                                </option>
                                <option data-countryCode="NP" style="color:black;" value="670">Northern Marianas
                                    (+670)
                                </option>
                                ...
                                <option data-countryCode="PG" style="color:black;" value="675">Papua New Guinea (+675)
                                </option>
                                ...
                                <option data-countryCode="PR" style="color:black;" value="1787">Puerto Rico (+1787)
                                </option>
                                ...
                                <option data-countryCode="SM" style="color:black;" value="378">San Marino (+378)
                                </option>
                                <option data-countryCode="ST" style="color:black;" value="239">Sao Tome &amp; Principe
                                    (+239)
                                </option>
                                <option data-countryCode="SA" style="color:black;" value="966">Saudi Arabia (+966)
                                </option>
                                ...
                                <option data-countryCode="SC" style="color:black;" value="248">Seychelles (+248)
                                </option>
                                <option data-countryCode="SL" style="color:black;" value="232">Sierra Leone (+232)
                                </option>
                                <option data-countryCode="SG" style="color:black;" value="65">Singapore (+65)</option>
                                <option data-countryCode="SK" style="color:black;" value="421">Slovak Republic (+421)
                                </option>
                                <option data-countryCode="SI" style="color:black;" value="386">Slovenia (+386)</option>
                                <option data-countryCode="SB" style="color:black;" value="677">Solomon Islands (+677)
                                </option>
                                <option data-countryCode="SO" style="color:black;" value="252">Somalia (+252)</option>
                                <option data-countryCode="ZA" style="color:black;" value="27">South Africa (+27)
                                </option>
                                ...
                                <option data-countryCode="SH" style="color:black;" value="290">St. Helena (+290)
                                </option>
                                <option data-countryCode="KN" style="color:black;" value="1869">St. Kitts (+1869)
                                </option>
                                <option data-countryCode="SC" style="color:black;" value="1758">St. Lucia (+1758)
                                </option>
                                ...
                                <option data-countryCode="TT" style="color:black;" value="1868">Trinidad &amp; Tobago
                                    (+1868)
                                </option>
                                ...
                                <option data-countryCode="TM" style="color:black;" value="993">Turkmenistan (+993)
                                </option>
                                <option data-countryCode="TC" style="color:black;" value="1649">Turks &amp; Caicos
                                    Islands (+1649)
                                </option>
                                ...
                                <option data-countryCode="AE" style="color:black;" value="971">United Arab Emirates
                                    (+971)
                                </option>
                                ...
                                <option data-countryCode="VA" style="color:black;" value="379">Vatican City (+379)
                                </option>
                                ...
                                <option data-countryCode="VG" style="color:black;" value="84">Virgin Islands - British
                                    (+1284)
                                </option>
                                <option data-countryCode="VI" style="color:black;" value="84">Virgin Islands - US
                                    (+1340)
                                </option>
                                <option data-countryCode="WF" style="color:black;" value="681">Wallis &amp; Futuna
                                    (+681)
                                </option>
                                <option data-countryCode="YE" style="color:black;" value="969">Yemen (North)(+969)
                                </option>
                                <option data-countryCode="YE" style="color:black;" value="967">Yemen (South)(+967)
                                </option>
                            ...
                            <input class="mobile-number" required type="tel" :placeholder="getTrans('phone')"
                                   v-model="contactUsData.mobile_number" autocomplete="off">
                        </div>
